    ...
    try:
        ...
        if v['state'] == 'online':
            ...
            try:
                ...
                print("collect_data_loop: EXCEPTION -> STATE_ERROR (cannot get charge_state -- ignoring and setting charge_state[charging_state] to Unknown): " + str(e))
                charge_state = {
            ...
            try:
                ...
                print("collect_data_loop: EXCEPTION -> STATE_ERROR (cannot get drive_state): " + str(e))
                return STATE_ERROR
            try:
                vehicle_state = v.data_request('vehicle_state')
                print("collect_data_loop: vehicle_state = " + str(vehicle_state))
            except Exception as e:
                print("collect_data_loop: EXCEPTION -> STATE_ERROR (cannot get vehicle_state): " + str(e))
                return STATE_ERROR
            print("collect_data_loop: vehicle_state[odometer] = " + str(vehicle_state['odometer']))
            print("collect_data_loop: charge_state[charging_state] = " + str(charge_state['charging_state']))
            ...
            #data = v.data();
            #print("collect_data_loop: all_vehicle_data = " + str(data));

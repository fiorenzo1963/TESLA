...
"""
tesla_info, if not null, must be:
        tesla_info['id'] = "e4a9949fcfa04068f59abb5a658f2bac0a3428e4652315490b659d5ab3f35a9e"
        tesla_info['secret'] = "c75f14bbadc8bee3a7594412c31416f8300256d7668ea7e6e7f06727bfb9d220"
        tesla_info['baseurl'] = "https://owner-api.teslamotors.com"
        tesla_info['api'] = "/api/1/"
"""
...
class Connection(object):
    ...
    def __init__(self,
        ...
        if tesla_info is not None:
            current_client['id'] = tesla_info['id']
            current_client['secret'] = tesla_info['secret']
            self.baseurl = tesla_info['baseurl']
            self.api = tesla_info['api']
        else:
